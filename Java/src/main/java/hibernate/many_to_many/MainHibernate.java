...
import hibernate.many_to_many.entity.Cart;
import hibernate.many_to_many.entity.Item;
...
public class MainHibernate {
    public static void main(String[] args) {
        ...
        session.close();
        /*Cart cart = new Cart(1, "jpa.hibernate.many_to_many.hibernate.one_to_many.entity.Cart");
        Item item1 = new Item(3);
        Item item2 = new Item(4);
        Set<Item> items = new HashSet<>();
        items.add(item1);
        ...
        session = hibernate.one_to_many.HibernateUtil.getSession();
